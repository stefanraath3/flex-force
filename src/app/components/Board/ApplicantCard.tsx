    ...
    >
      <div className="flex gap-[10px] items-center mb-[10px]">
        <div className="size-[38px] rounded-full overflow-hidden shrink-0">
          <ImageWithFallback src={applicant.avatar} alt={applicant.name} className="w-full h-full object-cover" />
        </div>
        <div className="flex flex-col overflow-hidden">
          <p className="font-semibold text-[#27272a] text-[14px] truncate">{applicant.name}</p>
          <p className="font-medium text-[#71717a] text-[12px] truncate">{applicant.email}</p>
        </div>
      </div>

      <div className="flex items-center gap-[6px]">
        <div className="bg-[#c6fffb] px-[4px] py-[2px] rounded-[4px] flex items-center justify-center">
          <span className="font-medium text-[#3f3f46] text-[12px]">{applicant.match}% match</span>
        </div>
        <div className="bg-[#f4f4f5] px-[4px] py-[2px] rounded-[4px] flex items-center justify-center gap-[4px]">
          ...
          <span className="font-medium text-[#52525b] text-[12px]">{applicant.location}</span>
        </div>
      </div>
    </div>
  );
